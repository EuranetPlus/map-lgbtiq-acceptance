export const config = {
	mapTitle: 'map-lgbtiq-acceptance', // The title of the map, if more than one word, separate by dash, e.g. "income-europe"
	vercelURL: 'map-lgbtiq-acceptance.vercel.app', // The url provided when deploying the map on Vercel
